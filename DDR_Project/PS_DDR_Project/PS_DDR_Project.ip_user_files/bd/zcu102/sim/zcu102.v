...
(* CORE_GENERATION_INFO = "zcu102,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=zcu102,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_zynq_ultra_ps_e_cnt=2,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "zcu102.hwdef" *) 
module zcu102
   ();

  wire zynq_ultra_ps_e_0_pl_clk0;

  zcu102_zynq_ultra_ps_e_0_1 zynq_ultra_ps_e_0
