...
HD_PWD='D:/Code_Programmed/Vivado_file/FPGA_CNN/PS_DDR_Project/PS_DDR_Project.runs/zcu102_zynq_ultra_ps_e_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zcu102_zynq_ultra_ps_e_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zcu102_zynq_ultra_ps_e_0_1.tcl
